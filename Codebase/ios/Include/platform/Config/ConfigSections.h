...
namespace Eegeo
{
    namespace Config
    {
        static const std::string CoverageTreeManifestUrlDefault = "http://cdn1.eegeo.com/coverage-trees/vglobal/v873/manifest.bin.gz";
        static const std::string CityThemesManifestUrlDefault   = "http://d2xvsc8j92rfya.cloudfront.net/mobile-themes-new/v512/manifest.txt.gz";
