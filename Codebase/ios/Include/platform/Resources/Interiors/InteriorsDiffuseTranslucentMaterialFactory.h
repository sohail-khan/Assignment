...
namespace Eegeo
{
    namespace Resources
    {
        namespace Interiors
        {
            class InteriorsDiffuseTranslucentMaterialFactory : public IInteriorsMaterialFactory, private Eegeo::NonCopyable
            {
            public:

                
                InteriorsDiffuseTranslucentMaterialFactory(Rendering::Materials::MaterialIdGenerator& materialIdGenerator,
                                                        const InteriorsDiffuseTranslucentShader& interiorsDiffuseSpecularShader,
            ...
            private:
                ...
                const InteriorsDiffuseTranslucentShader& m_interiorsDiffuseTranslucentShader;
