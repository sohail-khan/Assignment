    ...
    namespace Resources
    {
        namespace CityThemes
        {
            ...
            private:
                ...
                void SetWeatherOverlay()
                {
                    m_weatherOverlayMaterial.SetTextureId(m_toTextures->GetOverlayEffect());
                    m_weatherOverlayController.SetWeatherLayersParameters(m_toState.OverlayLayerOneOffset,
                                                                          m_toState.OverlayLayerOneVelocity,
                                                                          m_toState.OverlayLayerOneAlpha,
                                                                          m_toState.OverlayLayerOneScale,
                                                                          m_toState.OverlayLayerTwoOffset,
                                                                          m_toState.OverlayLayerTwoVelocity,
                                                                          m_toState.OverlayLayerTwoAlpha,
                                                                          m_toState.OverlayLayerTwoScale);
                }
