...
namespace Eegeo
{
	namespace Android
	{
		...
		class AndroidTextureFileLoader : public Eegeo::Helpers::ITextureFileLoader, protected Eegeo::NonCopyable
		{
            ...
            bool LoadKtx(Eegeo::Helpers::GLHelpers::TextureInfo &textureInfo, const std::string& filename);
        ...
        public:
            AndroidTextureFileLoader(Eegeo::Helpers::IFileIO *pFileIO, Eegeo::Helpers::Jpeg::IJpegLoader& jpegLoader);
            virtual ~AndroidTextureFileLoader();
