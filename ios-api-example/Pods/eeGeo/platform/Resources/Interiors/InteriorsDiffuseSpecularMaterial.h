...
namespace Eegeo
{
    namespace Resources
    {
        namespace Interiors
        {
            ...
            class InteriorsDiffuseSpecularMaterial : public InteriorsMaterialBase
            {
            public:
                InteriorsDiffuseSpecularMaterial(const Rendering::TMaterialId materialId,
                ...
                ~InteriorsDiffuseSpecularMaterial();
