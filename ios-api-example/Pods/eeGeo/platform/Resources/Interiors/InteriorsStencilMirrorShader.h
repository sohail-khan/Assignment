...
namespace Eegeo
{
    namespace Resources
    {
        namespace Interiors
        {
            class InteriorsStencilMirrorShader : public Rendering::Shader
            {
            public:
                static InteriorsStencilMirrorShader* Create(const Rendering::TShaderId shaderId);
                ...
                void SetFresnelCoefficients(float bias, float scale, float power) const;
            ...
            private:
                ...
                GLuint m_fresnelBiasScalePowerUniformLocation;
