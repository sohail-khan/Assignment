...
namespace Eegeo
{
    namespace Rendering
    {
        ...
        {
            class InstancedInteriorFloorRenderable : public InteriorRenderable
            {
            public:
                
                InstancedInteriorFloorRenderable(LayerIds::Values layerId,
                                        int floorIndex,
                                        ...
                                        bool ownsMesh,
                                        const std::vector<m44>& instanceTransforms);
                
                ~InstancedInteriorFloorRenderable();
            ...
            private:
                ...
                std::vector<m44> m_instanceTransforms;
                
                Geometry::SingleSphere m_overallBounds;
                std::vector<Geometry::SingleSphere> m_instanceBounds;
                std::vector<bool> m_visibleInstances;
            };
        }
    }
}