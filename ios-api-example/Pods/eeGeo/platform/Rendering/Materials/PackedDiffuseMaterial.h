...
namespace Eegeo
{
    namespace Rendering
    {
        namespace Materials
        {
            class PackedDiffuseMaterial : protected Eegeo::NonCopyable, public IDiffuseMaterial
            {            
            public:
                PackedDiffuseMaterial(
                                          const TMaterialId materialId,
                                          const std::string& name,
                                          Shaders::PackedDiffuseShader& shader,
            ...
            protected:
                ...
                Shaders::PackedDiffuseShader& m_shader;
